<template>
  <div class="border mb-6">
    <div v-if="editor" class="d-flex flex-wrap">
      <v-btn icon="mdi-format-header-2" rounded="0" variant="flat" @click="toggleHeading(2)" :active="isActive('heading', { level: 2 })">
      </v-btn>
      <v-btn icon="mdi-format-bold"  rounded="0" variant="flat" @click="toggleBold" :disabled="!canToggleBold()" :active="isActive('bold')">
      </v-btn>
      <v-btn icon="mdi-format-italic" rounded="0" variant="flat" @click="toggleItalic" :disabled="!canToggleItalic()" :active="isActive('italic')">
      </v-btn>
      ...
      <v-btn icon="mdi-format-list-bulleted" rounded="0" variant="flat" @click="toggleBulletList" :active="isActive('bulletList')">
      </v-btn>
      <v-btn icon="mdi-format-list-numbered" rounded="0" variant="flat" @click="toggleOrderedList" :active="isActive('orderedList')">
      </v-btn>
    </div>
